 ...
 *
 *
 * @package    propel.generator.Slims.Models.System.User.Base
 */
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Slims\\Models\\System\\User\\Map\\UserTableMap';
    ...
    /**
     * The value for the groups field.
     *
     * @var        string
     */
    protected $groups;
    ...
    /**
     * Initializes internal state of Slims\Models\System\User\Base\User object.
     */
     ...
     */
    public function getLast_login($format = NULL)
    {
        if ($format === null) {
     ...
     * @return $this|\Slims\Models\System\User\User The current object (for fluent API support)
     */
    ...
    public function setRealname($v)
    {
        ...
        if ($this->realname !== $v) {
            $this->realname = $v;
            $this->modifiedColumns[UserTableMap::COL_REALNAME] = true;
        }
     ...
     * @return $this|\Slims\Models\System\User\User The current object (for fluent API support)
     */
    public function setUser_type($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
     ...
     * @return $this|\Slims\Models\System\User\User The current object (for fluent API support)
     */
    public function setUser_image($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->user_image !== $v) {
            $this->user_image = $v;
            $this->modifiedColumns[UserTableMap::COL_USER_IMAGE] = true;
        }
     ...
     * @return $this|\Slims\Models\System\User\User The current object (for fluent API support)
     */
    public function setSocial_media($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->social_media !== $v) {
            $this->social_media = $v;
            $this->modifiedColumns[UserTableMap::COL_SOCIAL_MEDIA] = true;
        }
     ...
     * @return $this|\Slims\Models\System\User\User The current object (for fluent API support)
     */
    public function setLast_login($v)
    {
     ...
     * @return $this|\Slims\Models\System\User\User The current object (for fluent API support)
     */
    public function setLast_login_ip($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
    ...
    /**
     * Set the value of [groups] column.
     *
     * @param string $v new value
     * @return $this|\Slims\Models\System\User\User The current object (for fluent API support)
     */
    public function setGroups($v)
    {
        ...
        if ($this->groups !== $v) {
            $this->groups = $v;
            $this->modifiedColumns[UserTableMap::COL_GROUPS] = true;
        }
    ...
    public function setInput_date($v)
    {
        ...
        if ($this->input_date !== null || $dt !== null) {
            if ($this->input_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->input_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserTableMap::COL_INPUT_DATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserTableMap::translateFieldName('User_type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('User_image', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_image = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UserTableMap::translateFieldName('Social_media', TableMap::TYPE_PHPNAME, $indexType)];
            $this->social_media = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UserTableMap::translateFieldName('Last_login', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->last_login = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UserTableMap::translateFieldName('Last_login_ip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_login_ip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : UserTableMap::translateFieldName('Groups', TableMap::TYPE_PHPNAME, $indexType)];
            $this->groups = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : UserTableMap::translateFieldName('Api_key', TableMap::TYPE_PHPNAME, $indexType)];
            $this->api_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : UserTableMap::translateFieldName('Input_date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->input_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : UserTableMap::translateFieldName('Last_update', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Slims\\Models\\System\\User\\User'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_REALNAME)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USER_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'user_image';
        }
        if ($this->isColumnModified(UserTableMap::COL_SOCIAL_MEDIA)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_GROUPS)) {
            $modifiedColumns[':p' . $index++]  = 'groups';
        }
        if ($this->isColumnModified(UserTableMap::COL_API_KEY)) {
            $modifiedColumns[':p' . $index++]  = 'api_key';
        }
        if ($this->isColumnModified(UserTableMap::COL_INPUT_DATE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'user_type':
                        ...
                        break;
                    case 'user_image':
                        $stmt->bindValue($identifier, $this->user_image, PDO::PARAM_STR);
                        break;
                    case 'social_media':
                        $stmt->bindValue($identifier, $this->social_media, PDO::PARAM_STR);
                        break;
                    case 'last_login':
                    ...
                    case 'last_login_ip':
                        ...
                        break;
                    case 'groups':
                        $stmt->bindValue($identifier, $this->groups, PDO::PARAM_STR);
                        break;
                    case 'api_key':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                return $this->getUser_image();
                break;
            case 7:
                return $this->getSocial_media();
                break;
            case 8:
                return $this->getLast_login();
                break;
            case 9:
                return $this->getLast_login_ip();
                break;
            case 10:
                return $this->getGroups();
                break;
            case 11:
                return $this->getApi_key();
                break;
            case 12:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getUser_type(),
            $keys[6] => $this->getUser_image(),
            $keys[7] => $this->getSocial_media(),
            $keys[8] => $this->getLast_login(),
            $keys[9] => $this->getLast_login_ip(),
            $keys[10] => $this->getGroups(),
            $keys[11] => $this->getApi_key(),
            $keys[12] => $this->getInput_date(),
            $keys[13] => $this->getLast_update(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Slims\Models\System\User\User
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                $this->setUser_image($value);
                break;
            case 7:
                $this->setSocial_media($value);
                break;
            case 8:
                $this->setLast_login($value);
                break;
            case 9:
                $this->setLast_login_ip($value);
                break;
            case 10:
                $this->setGroups($value);
                break;
            case 11:
                $this->setApi_key($value);
                break;
            case 12:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setUser_type($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setUser_image($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setSocial_media($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setLast_login($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setLast_login_ip($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setGroups($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setApi_key($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setInput_date($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setLast_update($arr[$keys[13]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Slims\Models\System\User\User The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_REALNAME)) {
            $criteria->add(UserTableMap::COL_REALNAME, $this->realname);
        }
        if ($this->isColumnModified(UserTableMap::COL_PASSWORD)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USER_IMAGE)) {
            $criteria->add(UserTableMap::COL_USER_IMAGE, $this->user_image);
        }
        if ($this->isColumnModified(UserTableMap::COL_SOCIAL_MEDIA)) {
            $criteria->add(UserTableMap::COL_SOCIAL_MEDIA, $this->social_media);
        }
        if ($this->isColumnModified(UserTableMap::COL_LAST_LOGIN)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_GROUPS)) {
            $criteria->add(UserTableMap::COL_GROUPS, $this->groups);
        }
        if ($this->isColumnModified(UserTableMap::COL_API_KEY)) {
            $criteria->add(UserTableMap::COL_API_KEY, $this->api_key);
        }
        if ($this->isColumnModified(UserTableMap::COL_INPUT_DATE)) {
            $criteria->add(UserTableMap::COL_INPUT_DATE, $this->input_date);
        }
        if ($this->isColumnModified(UserTableMap::COL_LAST_UPDATE)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Slims\Models\System\User\User (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUser_type($this->getUser_type());
        $copyObj->setUser_image($this->getUser_image());
        $copyObj->setSocial_media($this->getSocial_media());
        $copyObj->setLast_login($this->getLast_login());
        $copyObj->setLast_login_ip($this->getLast_login_ip());
        $copyObj->setGroups($this->getGroups());
        $copyObj->setApi_key($this->getApi_key());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Slims\Models\System\User\User Clone of current object.
     * @throws PropelException
     */
     ...
     * @return ObjectCollection|Biblio[] List of Biblio objects
     */
    public function getBibliosJoinFrequency(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = BiblioQuery::create(null, $criteria);
        $query->joinWith('Frequency', $joinBehavior);
