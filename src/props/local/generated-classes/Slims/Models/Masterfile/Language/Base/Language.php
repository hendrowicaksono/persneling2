...
/**
 * Base class that represents a row from the 'mst_language' table.
 *
 *
 *
 * @package    propel.generator.Slims.Models.Masterfile.Language.Base
 */
abstract class Language implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Slims\\Models\\Masterfile\\Language\\Map\\LanguageTableMap';
    ...
    /**
     * Initializes internal state of Slims\Models\Masterfile\Language\Base\Language object.
     */
     ...
     * @return $this|\Slims\Models\Masterfile\Language\Language The current object (for fluent API support)
     */
     ...
     * @return $this|\Slims\Models\Masterfile\Language\Language The current object (for fluent API support)
     */
    public function setLanguage_name($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LanguageTableMap::translateFieldName('Language_name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Slims\\Models\\Masterfile\\Language\\Language'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO mst_language (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Slims\Models\Masterfile\Language\Language
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setLanguage_name($arr[$keys[1]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Slims\Models\Masterfile\Language\Language The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Slims\Models\Masterfile\Language\Language (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLanguage_name($this->getLanguage_name());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Slims\Models\Masterfile\Language\Language Clone of current object.
     * @throws PropelException
     */
    ...
    public function setBiblios(Collection $biblios, ConnectionInterface $con = null)
    {
        ...
        foreach ($bibliosToDelete as $biblioRemoved) {
            $biblioRemoved->setLanguage(null);
        }
