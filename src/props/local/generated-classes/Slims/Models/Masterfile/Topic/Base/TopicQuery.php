...
namespace Slims\Models\Masterfile\Topic\Base;
...
use Slims\Models\Masterfile\Topic\Topic as ChildTopic;
use Slims\Models\Masterfile\Topic\TopicQuery as ChildTopicQuery;
use Slims\Models\Masterfile\Topic\Map\TopicTableMap;

/**
 * Base class that represents a query for the 'mst_topic' table.
 *
 *
 *
 * @method     ChildTopicQuery orderByTopicId($order = Criteria::ASC) Order by the topic_id column
 * @method     ChildTopicQuery orderByTopic($order = Criteria::ASC) Order by the topic column
 *
 * @method     ChildTopicQuery groupByTopicId() Group by the topic_id column
 * @method     ChildTopicQuery groupByTopic() Group by the topic column
 *
 ...
 *
 * @method     ChildTopicQuery leftJoinBiblioTopic($relationAlias = null) Adds a LEFT JOIN clause to the query using the BiblioTopic relation
 * @method     ChildTopicQuery rightJoinBiblioTopic($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BiblioTopic relation
 * @method     ChildTopicQuery innerJoinBiblioTopic($relationAlias = null) Adds a INNER JOIN clause to the query using the BiblioTopic relation
 *
 * @method     ChildTopicQuery joinWithBiblioTopic($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BiblioTopic relation
 *
 * @method     ChildTopicQuery leftJoinWithBiblioTopic() Adds a LEFT JOIN clause and with to the query using the BiblioTopic relation
 * @method     ChildTopicQuery rightJoinWithBiblioTopic() Adds a RIGHT JOIN clause and with to the query using the BiblioTopic relation
 * @method     ChildTopicQuery innerJoinWithBiblioTopic() Adds a INNER JOIN clause and with to the query using the BiblioTopic relation
 *
 * @method     \Slims\Models\Masterfile\BiblioTopic\BiblioTopicQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildTopic findOneByTopic(string $topic) Return the first ChildTopic filtered by the topic column *
 ...
 * @method     ChildTopic requireOneByTopic(string $topic) Return the first ChildTopic filtered by the topic column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildTopic[]|ObjectCollection findByTopic(string $topic) Return ChildTopic objects filtered by the topic column
...
abstract class TopicQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Slims\Models\Masterfile\Topic\Base\TopicQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'slims', $modelName = '\\Slims\\Models\\Masterfile\\Topic\\Topic', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT topic_id, topic FROM mst_topic WHERE topic_id = :p0';
        try {
    ...
    public function filterByTopic($topic = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TopicTableMap::COL_TOPIC, $topic, $comparison);
    }
    ...
    public function filterByBiblioTopic($biblioTopic, $comparison = null)
    {
        if ($biblioTopic instanceof \Slims\Models\Masterfile\BiblioTopic\BiblioTopic) {
            return $this
                ->addUsingAlias(TopicTableMap::COL_TOPIC_ID, $biblioTopic->getTopicId(), $comparison);
