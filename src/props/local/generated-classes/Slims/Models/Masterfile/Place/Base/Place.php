...
/**
 * Base class that represents a row from the 'mst_place' table.
 *
 *
 *
 * @package    propel.generator.Slims.Models.Masterfile.Place.Base
 */
abstract class Place implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Slims\\Models\\Masterfile\\Place\\Map\\PlaceTableMap';
    ...
    /**
     * The value for the place_name field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Slims\Models\Masterfile\Place\Base\Place object.
     */
    ...
    /**
     * Get the [place_name] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Slims\Models\Masterfile\Place\Place The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [place_name] column.
     *
     * @param string $v new value
     * @return $this|\Slims\Models\Masterfile\Place\Place The current object (for fluent API support)
     */
    public function setPlace_name($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->place_name !== $v) {
            $this->place_name = $v;
            $this->modifiedColumns[PlaceTableMap::COL_PLACE_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PlaceTableMap::translateFieldName('Place_name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->place_name = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = PlaceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Slims\\Models\\Masterfile\\Place\\Place'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PlaceTableMap::COL_PLACE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'place_name';
        }

        $sql = sprintf(
            'INSERT INTO mst_place (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'place_id':
                        ...
                        break;
                    case 'place_name':
                        $stmt->bindValue($identifier, $this->place_name, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Slims\Models\Masterfile\Place\Place
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Slims\Models\Masterfile\Place\Place The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PlaceTableMap::COL_PLACE_NAME)) {
            $criteria->add(PlaceTableMap::COL_PLACE_NAME, $this->place_name);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Slims\Models\Masterfile\Place\Place (or compatible) type.
    ...
    {
        $copyObj->setPlace_name($this->getPlace_name());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Slims\Models\Masterfile\Place\Place Clone of current object.
     * @throws PropelException
     */
