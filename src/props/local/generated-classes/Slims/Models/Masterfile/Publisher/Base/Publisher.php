...
/**
 * Base class that represents a row from the 'mst_publisher' table.
 *
 *
 *
 * @package    propel.generator.Slims.Models.Masterfile.Publisher.Base
 */
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Slims\\Models\\Masterfile\\Publisher\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of Slims\Models\Masterfile\Publisher\Base\Publisher object.
     */
     ...
     * @return $this|\Slims\Models\Masterfile\Publisher\Publisher The current object (for fluent API support)
     */
     ...
     * @return $this|\Slims\Models\Masterfile\Publisher\Publisher The current object (for fluent API support)
     */
    public function setPublisher_name($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PublisherTableMap::translateFieldName('PublisherId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->publisher_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PublisherTableMap::translateFieldName('Publisher_name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Slims\\Models\\Masterfile\\Publisher\\Publisher'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO mst_publisher (%s) VALUES (%s)',
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getPublisherId(),
            $keys[1] => $this->getPublisher_name(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Slims\Models\Masterfile\Publisher\Publisher
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setPublisherId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setPublisher_name($arr[$keys[1]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Slims\Models\Masterfile\Publisher\Publisher The current object, for fluid interface
     */
    ...
    {
        $validPk = null !== $this->getPublisherId();
    ...
    {
        return null === $this->getPublisherId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Slims\Models\Masterfile\Publisher\Publisher (or compatible) type.
    ...
    {
        $copyObj->setPublisher_name($this->getPublisher_name());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setPublisherId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Slims\Models\Masterfile\Publisher\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function setBiblios(Collection $biblios, ConnectionInterface $con = null)
    {
        ...
        foreach ($bibliosToDelete as $biblioRemoved) {
            $biblioRemoved->setPublisher(null);
        }
