...
/**
 * Base class that represents a row from the 'mst_coll_type' table.
 *
 *
 *
 * @package    propel.generator.Slims.Models.Masterfile.Colltype.Base
 */
abstract class Colltype implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Slims\\Models\\Masterfile\\Colltype\\Map\\ColltypeTableMap';
    ...
    /**
     * The value for the coll_type_name field.
     *
     * @var        string
     */
    protected $coll_type_name;
    ...
    /**
     * Initializes internal state of Slims\Models\Masterfile\Colltype\Base\Colltype object.
     */
    ...
    /**
     * Compares this with another <code>Colltype</code> instance.  If
     * <code>obj</code> is an instance of <code>Colltype</code>, delegates to
     * <code>equals(Colltype)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Colltype The current object, for fluid interface
     */
     ...
     * @return int
     */
    public function getCollTypeId()
    {
        return $this->coll_type_id;
    }

    /**
     * Get the [coll_type_name] column value.
     *
     * @return string
     */
    public function getColl_type_name()
    {
     ...
     * @return $this|\Slims\Models\Masterfile\Colltype\Colltype The current object (for fluent API support)
     */
    public function setCollTypeId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->coll_type_id !== $v) {
            $this->coll_type_id = $v;
            $this->modifiedColumns[ColltypeTableMap::COL_COLL_TYPE_ID] = true;
        }
    ...
    /**
     * Set the value of [coll_type_name] column.
     *
     * @param string $v new value
     * @return $this|\Slims\Models\Masterfile\Colltype\Colltype The current object (for fluent API support)
     */
    public function setColl_type_name($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->coll_type_name !== $v) {
            $this->coll_type_name = $v;
            $this->modifiedColumns[ColltypeTableMap::COL_COLL_TYPE_NAME] = true;
        }
    ...
    public function setInput_date($v)
    {
        ...
        if ($this->input_date !== null || $dt !== null) {
            if ($this->input_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->input_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ColltypeTableMap::COL_INPUT_DATE] = true;
            }
    ...
    public function setLast_update($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            if ($this->last_update === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_update->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ColltypeTableMap::COL_LAST_UPDATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ColltypeTableMap::translateFieldName('CollTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->coll_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ColltypeTableMap::translateFieldName('Coll_type_name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->coll_type_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ColltypeTableMap::translateFieldName('Input_date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->input_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ColltypeTableMap::translateFieldName('Last_update', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = ColltypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Slims\\Models\\Masterfile\\Colltype\\Colltype'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildColltypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Colltype::setDeleted()
     * @see Colltype::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildColltypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ColltypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ColltypeTableMap::COL_COLL_TYPE_ID] = true;
        if (null !== $this->coll_type_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ColltypeTableMap::COL_COLL_TYPE_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ColltypeTableMap::COL_COLL_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'coll_type_id';
        }
        if ($this->isColumnModified(ColltypeTableMap::COL_COLL_TYPE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'coll_type_name';
        }
        if ($this->isColumnModified(ColltypeTableMap::COL_INPUT_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'input_date';
        }
        if ($this->isColumnModified(ColltypeTableMap::COL_LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'last_update';
        }

        $sql = sprintf(
            'INSERT INTO mst_coll_type (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'coll_type_id':
                        ...
                        break;
                    case 'coll_type_name':
                        $stmt->bindValue($identifier, $this->coll_type_name, PDO::PARAM_STR);
                        break;
                    case 'input_date':
    ...
    {
        $pos = ColltypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getCollTypeId();
                break;
            case 1:
                return $this->getColl_type_name();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Colltype'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Colltype'][$this->hashCode()] = true;
        $keys = ColltypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCollTypeId(),
            $keys[1] => $this->getColl_type_name(),
            $keys[2] => $this->getInput_date(),
            $keys[3] => $this->getLast_update(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Slims\Models\Masterfile\Colltype\Colltype
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setCollTypeId($value);
                break;
            case 1:
                $this->setColl_type_name($value);
                break;
            case 2:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCollTypeId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setColl_type_name($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setInput_date($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setLast_update($arr[$keys[3]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Slims\Models\Masterfile\Colltype\Colltype The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(ColltypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ColltypeTableMap::COL_COLL_TYPE_ID)) {
            $criteria->add(ColltypeTableMap::COL_COLL_TYPE_ID, $this->coll_type_id);
        }
        if ($this->isColumnModified(ColltypeTableMap::COL_COLL_TYPE_NAME)) {
            $criteria->add(ColltypeTableMap::COL_COLL_TYPE_NAME, $this->coll_type_name);
        }
        if ($this->isColumnModified(ColltypeTableMap::COL_INPUT_DATE)) {
            $criteria->add(ColltypeTableMap::COL_INPUT_DATE, $this->input_date);
        }
        if ($this->isColumnModified(ColltypeTableMap::COL_LAST_UPDATE)) {
            $criteria->add(ColltypeTableMap::COL_LAST_UPDATE, $this->last_update);
        }
    ...
    {
        $criteria = ChildColltypeQuery::create();
        $criteria->add(ColltypeTableMap::COL_COLL_TYPE_ID, $this->coll_type_id);
    ...
    {
        $validPk = null !== $this->getCollTypeId();
    ...
    /**
     * Generic method to set the primary key (coll_type_id column).
     *
    ...
    {
        return null === $this->getCollTypeId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Slims\Models\Masterfile\Colltype\Colltype (or compatible) type.
    ...
    {
        $copyObj->setColl_type_name($this->getColl_type_name());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCollTypeId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Slims\Models\Masterfile\Colltype\Colltype Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildColltype is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildColltype The current object (for fluent API support)
     */
     ...
     * Otherwise if this Colltype is new, it will return
     * an empty collection; or if this Colltype has previously
     * been saved, it will retrieve related Items from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Colltype.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|Item[] List of Item objects
     */
    public function getItemsJoinBiblio(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ItemQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ColltypeTableMap::DEFAULT_STRING_FORMAT);
    }
