...
/**
 * Base class that represents a row from the 'biblio_topic' table.
 *
 *
 *
 * @package    propel.generator.Slims.Models.Masterfile.BiblioTopic.Base
 */
abstract class BiblioTopic implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Slims\\Models\\Masterfile\\BiblioTopic\\Map\\BiblioTopicTableMap';
    ...
    /**
     * Initializes internal state of Slims\Models\Masterfile\BiblioTopic\Base\BiblioTopic object.
     */
    ...
    /**
     * Compares this with another <code>BiblioTopic</code> instance.  If
     * <code>obj</code> is an instance of <code>BiblioTopic</code>, delegates to
     * <code>equals(BiblioTopic)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|BiblioTopic The current object, for fluid interface
     */
     ...
     * @return $this|\Slims\Models\Masterfile\BiblioTopic\BiblioTopic The current object (for fluent API support)
     */
    public function setBiblioId($v)
    {
        ...
        if ($this->biblio_id !== $v) {
            $this->biblio_id = $v;
            $this->modifiedColumns[BiblioTopicTableMap::COL_BIBLIO_ID] = true;
        }
    ...
    public function setTopicId($v)
    {
        ...
        if ($this->topic_id !== $v) {
            $this->topic_id = $v;
            $this->modifiedColumns[BiblioTopicTableMap::COL_TOPIC_ID] = true;
        }
    ...
    public function setLevel($v)
    {
        ...
        if ($this->level !== $v) {
            $this->level = $v;
            $this->modifiedColumns[BiblioTopicTableMap::COL_LEVEL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BiblioTopicTableMap::translateFieldName('BiblioId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->biblio_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BiblioTopicTableMap::translateFieldName('TopicId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->topic_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BiblioTopicTableMap::translateFieldName('Level', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = BiblioTopicTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Slims\\Models\\Masterfile\\BiblioTopic\\BiblioTopic'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBiblioTopicQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BiblioTopic::setDeleted()
     * @see BiblioTopic::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBiblioTopicQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BiblioTopicTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BiblioTopicTableMap::COL_BIBLIO_ID)) {
            $modifiedColumns[':p' . $index++]  = 'biblio_id';
        }
        if ($this->isColumnModified(BiblioTopicTableMap::COL_TOPIC_ID)) {
            $modifiedColumns[':p' . $index++]  = 'topic_id';
        }
        if ($this->isColumnModified(BiblioTopicTableMap::COL_LEVEL)) {
            $modifiedColumns[':p' . $index++]  = 'level';
        }

        $sql = sprintf(
            'INSERT INTO biblio_topic (%s) VALUES (%s)',
    ...
    {
        $pos = BiblioTopicTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['BiblioTopic'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BiblioTopic'][$this->hashCode()] = true;
        $keys = BiblioTopicTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Slims\Models\Masterfile\BiblioTopic\BiblioTopic
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Slims\Models\Masterfile\BiblioTopic\BiblioTopic The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BiblioTopicTableMap::COL_BIBLIO_ID)) {
            $criteria->add(BiblioTopicTableMap::COL_BIBLIO_ID, $this->biblio_id);
        }
        if ($this->isColumnModified(BiblioTopicTableMap::COL_TOPIC_ID)) {
            $criteria->add(BiblioTopicTableMap::COL_TOPIC_ID, $this->topic_id);
        }
        if ($this->isColumnModified(BiblioTopicTableMap::COL_LEVEL)) {
            $criteria->add(BiblioTopicTableMap::COL_LEVEL, $this->level);
        }
    ...
    {
        $criteria = ChildBiblioTopicQuery::create();
        $criteria->add(BiblioTopicTableMap::COL_BIBLIO_ID, $this->biblio_id);
        $criteria->add(BiblioTopicTableMap::COL_TOPIC_ID, $this->topic_id);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getBiblioId() &&
            null !== $this->getTopicId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation biblio_topic_fk_ea58a3 to table biblio
        ...
        //relation biblio_topic_fk_fcb4f0 to table mst_topic
    ...
    {
        return (null === $this->getBiblioId()) && (null === $this->getTopicId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Slims\Models\Masterfile\BiblioTopic\BiblioTopic (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Slims\Models\Masterfile\BiblioTopic\BiblioTopic Clone of current object.
     * @throws PropelException
     */
    ...
    public function getBiblio(ConnectionInterface $con = null)
    {
        if ($this->aBiblio === null && ($this->biblio_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBiblio->addBiblioTopics($this);
             */
        }
    ...
    public function getTopic(ConnectionInterface $con = null)
    {
        if ($this->aTopic === null && ($this->topic_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTopic->addBiblioTopics($this);
             */
        }
    ...
    {
        if (null !== $this->aBiblio) {
            $this->aBiblio->removeBiblioTopic($this);
        }
        if (null !== $this->aTopic) {
            $this->aTopic->removeBiblioTopic($this);
        }
        $this->biblio_id = null;
        $this->topic_id = null;
        $this->level = null;
    ...
    {
        return (string) $this->exportTo(BiblioTopicTableMap::DEFAULT_STRING_FORMAT);
    }
